...
class AzureProvider(SpeechRecProvider):
    def __init__(self):
        ...
        if helper.choose_yes_no("Are you going to be speaking in a language other than english?"
            ...
            speech_config = speechsdk.SpeechConfig(subscription=configData["speech_key"], endpoint=endpoint_string)
        ...
        if auto_detect_source_language_config is not None:
            self.speech_recognizer: speechsdk.SpeechRecognizer = speechsdk.SpeechRecognizer(speech_config=speech_config,
